...
import org.com.hcmurs.Screen // Đảm bảo đã import đúng gói Screen của bạn
...
fun RegisterScreen(
    ...
    Box(
        ...
        // Background Image
        Image(
            painter = painterResource(id = R.drawable.loginbackground), // Sử dụng hình nền tương tự
        ...
        Column(
            ...
            Column(
                ...
                Button(
                    onClick = { /* TODO: Implement Sign Up logic later */ },
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(56.dp),
                ...
                OutlinedButton(
                    onClick = { /* TODO: Implement Facebook sign up */ },
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(56.dp),
...
fun RegisterScreenPreview() {
    val dummyRegisterViewModel = RegisterViewModel(null, null)
    val dummyMainViewModel = MainViewModel()
    
    LaunchedEffect(Unit) {
        dummyRegisterViewModel.updateUsername("newuser")
        dummyRegisterViewModel.updateEmail("newuser@example.com")
        dummyRegisterViewModel.updatePassword("securepassword")
    }
    
    RegisterScreen(
        navController = NavHostController(LocalContext.current),
        viewModel = dummyRegisterViewModel,
